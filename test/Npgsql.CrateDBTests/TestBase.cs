...
namespace Npgsql.CrateDBTests
{
    public abstract class TestBase
    {
        ...
        /// test database.
        /// </summary>
        const string DefaultConnectionString = "Server=localhost;User ID=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=0;Command Timeout=0;Server Compatibility Mode=CrateDB";
