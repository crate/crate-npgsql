...
{
    class CrateTimestampHandlerFactory : NpgsqlTypeHandlerFactory<DateTime>
    {
        protected override NpgsqlTypeHandler<DateTime> Create(NpgsqlConnection conn)
        {
            return new CrateTimestampHandler();
        }
    }

    class CrateTimestampHandler : NpgsqlSimpleTypeHandler<DateTime>
    {
        internal static readonly DateTime PostgresEpoch = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);

        public CrateTimestampHandler() : base()
        {
        }
